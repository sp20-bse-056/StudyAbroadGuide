...
const Destinations = () => {
  ...
  <div className="mb-9 uk text-center">
    <img
      className={`  mx-auto h-[240px] md:h-[270px]  w-[400px] object-cover rounded-md shadow-lg hover:shadow-xl transition   ${isVisible ? 'opacity-100' : 'opacity-0'}`}
    ...
    Embark on a transformative academic journey in the UK, where world-class education, diverse cultures, and unparalleled career opportunities converge to shape a future of limitless possibilities. </p>
  ...
  <div className="Australia text-center">
    ...
    Immerse yourself in Australia's vibrant academic landscape, where world-renowned universities, a welcoming multicultural society, and stunning landscapes converge to provide a transformative and globally recognized education experience. </p>
...
/>
    ...
    Experience the rich tapestry of academia in China, where ancient traditions meet cutting-edge innovation, fostering a unique learning environment that propels your education and future career to new heights </p>
